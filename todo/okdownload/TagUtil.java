...
public class TagUtil {
    ...
    private static final int KEY_ICON_URL = 5;
    ...
    public static void saveTaskIcon(DownloadTask task, String icon) {
        task.addTag(KEY_ICON_URL, icon);
    }

    public static String getTaskIcon(DownloadTask task) {
        final Object taskIcon = task.getTag(KEY_ICON_URL);
        return taskIcon != null ? (String) taskIcon : null;
    }
